...
@endonce
    ...
    <div wire:ignore>
        <button
            type="button"
            onclick="window.dispatchEvent(new CustomEvent('open-update-profile'))"
    ...
    <div
        ...
        x-show="show"
        @open-update-profile.window="show = true"
        @close-update-profile.window="show = false"
        ...
        @keydown.escape.window="window.dispatchEvent(new CustomEvent('close-update-profile'))"
        class="fixed inset-0 z-50 flex items-center justify-center p-4"
        style="background:rgba(0,0,0,0.82);backdrop-filter:blur(10px);display:none;"
    >
        <div
            x-show="show"
            x-transition:enter="transition ease-out duration-300"
            ...
            @click.away="window.dispatchEvent(new CustomEvent('close-update-profile'))"
                ...
                <div class="up-hero-content">
                    <div class="up-hero-left">
                        ...
                        <div class="up-hero-avatar"
                             ...
                             @profile-saved.window="src = $event.detail.avatarUrl">
            ...
            <form wire:submit.prevent="update" style="display:flex;flex-direction:column;flex:1;min-height:0;">
                ...
                <div class="up-body">
                    ...
                    <div class="up-section">
                        ...
                        <div class="up-photo-row"
                             x-data="{ previewSrc: '' }"
                             x-init="previewSrc = await $wire.get('avatarUrl')"
                             @profile-saved.window="previewSrc = $event.detail.avatarUrl">
                                ...
                                <input
                                    ...
                                    x-on:change="
                                        ...
                                        reader.onload = async e => {
                                            ...
                                            await $wire.call('receivePhoto', dataUri);
                                        };
                ...
                <div class="up-footer">
                    ...
                    >
                        ...
                        <span wire:loading wire:target="update" style="display:inline-flex;align-items:center;gap:0.5rem;">
