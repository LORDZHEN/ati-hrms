<x-filament-panels::page>
    <div class="max-w-7xl mx-auto space-y-2 p-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            ...
            <div class="bg-gradient-to-r from-green-600 to-amber-500 p-8 pt-10 rounded-t-xl">
                <div class="flex flex-col md:flex-row items-center md:items-start gap-6">
                    ...
                    <div class="flex-1 text-center md:text-left space-y-4">
                        <div>
                            <h1 class="text-2xl md:text-4xl font-bold text-black drop-shadow-lg mb-3">
                                {{ Auth::user()->name }}
                            </h1>
                            <div class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/25 backdrop-blur-md rounded-full border border-white/40 shadow-lg">
                                <x-heroicon-o-envelope class="w-5 h-5 text-black" />
                        ...
                        <div class="flex flex-wrap gap-3 justify-center md:justify-start">
                            <div class="px-4 py-2.5 bg-white/25 backdrop-blur-sm rounded-xl border border-white/40 min-w-[120px]">
                                <p class="text-xs text-black/70 font-semibold uppercase tracking-wide">Employee ID</p>
                                <p class="text-base font-bold text-black mt-0.5">{{ Auth::user()->employee_id }}</p>
                            </div>

                            @if(Auth::user()->position)
                            <div class="px-4 py-2.5 bg-white/25 backdrop-blur-sm rounded-xl border border-white/40 min-w-[140px]">
                                <p class="text-xs text-black/70 font-semibold uppercase tracking-wide">Position</p>
                                <p class="text-sm font-bold text-black mt-0.5 truncate">{{ Auth::user()->position }}</p>
                            </div>
                            @endif

                            @if(Auth::user()->employment_status)
                            <div class="px-4 py-2.5 bg-white/25 backdrop-blur-sm rounded-xl border border-white/40 min-w-[120px]">
                                <p class="text-xs text-black/70 font-semibold uppercase tracking-wide">Status</p>
                                <p class="text-sm font-bold text-black mt-0.5">{{ Auth::user()->employment_status }}</p>
                            </div>
                            @endif
                        </div>
                    </div>
            ...
            <div class="p-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 rounded-b-xl">
                <div class="flex items-center gap-3 mb-6">
                    <div class="p-3 bg-gradient-to-br from-green-600 to-green-700 rounded-xl shadow-lg">
                        <x-heroicon-o-information-circle class="w-6 h-6 text-black" />
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    ...
                    <div class="group flex items-center gap-4 p-5 rounded-xl bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl hover:border-green-300 dark:hover:border-green-700 transition-all">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-base font-bold text-gray-900 dark:text-black truncate">{{ Auth::user()->name }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="group flex items-center gap-4 p-5 rounded-xl bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl hover:border-amber-300 dark:hover:border-amber-700 transition-all">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-base font-bold text-gray-900 dark:text-black truncate">{{ Auth::user()->employee_id }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="group flex items-center gap-4 p-5 rounded-xl bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl hover:border-green-300 dark:hover:border-green-700 transition-all">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-base font-bold text-gray-900 dark:text-black truncate">{{ Auth::user()->position }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="group flex items-center gap-4 p-5 rounded-xl bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl hover:border-amber-300 dark:hover:border-amber-700 transition-all">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-base font-bold text-gray-900 dark:text-black truncate">{{ Auth::user()->employment_status }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="group flex items-center gap-4 p-5 rounded-xl bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl hover:border-green-300 dark:hover:border-green-700 transition-all">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-base font-bold text-gray-900 dark:text-black truncate">{{ Auth::user()->department }}</p>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="group flex items-center gap-4 p-5 rounded-xl bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 shadow-md hover:shadow-xl hover:border-amber-300 dark:hover:border-amber-700 transition-all">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-base font-bold text-gray-900 dark:text-black truncate">{{ Auth::user()->created_at->format('F d, Y') }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-white to-green-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl shadow-xl border-2 border-green-200 dark:border-green-800 p-6 hover:shadow-2xl transition-all">
                <div class="flex items-center gap-4 mb-6">
                    <div class="flex-shrink-0 p-4 bg-gradient-to-br from-green-600 to-green-700 rounded-xl shadow-lg">
                        <x-heroicon-o-user-circle class="w-8 h-8 text-black" />
                    </div>
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 dark:text-black">Update Profile</h2>
            ...
            <div class="bg-gradient-to-br from-white to-amber-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl shadow-xl border-2 border-amber-200 dark:border-amber-800 p-6 hover:shadow-2xl transition-all">
                <div class="flex items-center gap-4 mb-6">
                    <div class="flex-shrink-0 p-4 bg-gradient-to-br from-amber-500 to-amber-600 rounded-xl shadow-lg">
                        <x-heroicon-o-lock-closed class="w-8 h-8 text-black" />
                    </div>
                    <div>
                        <h2 class="text-xl font-bold text-gray-900 dark:text-black">Change Password</h2>
        ...
        <div class="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-gray-800 dark:to-gray-800 rounded-2xl border-2 border-green-300 dark:border-green-700 p-6 shadow-xl">
            <div class="flex items-start gap-4">
                <div class="flex-shrink-0 p-4 bg-gradient-to-br from-green-600 to-emerald-600 rounded-xl shadow-lg">
                    <x-heroicon-o-shield-check class="w-7 h-7 text-black" />
                </div>
                <div class="flex-1">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-black mb-4">Security Best Practices</h3>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="flex items-start gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                            <div class="flex-shrink-0 p-1.5 bg-green-600 rounded-full mt-0.5">
                                <x-heroicon-o-check class="w-4 h-4 text-black" />
                            </div>
                            <p class="text-sm text-gray-700 dark:text-gray-300 font-medium">Use a strong, unique password</p>
                        </div>
                        <div class="flex items-start gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                            <div class="flex-shrink-0 p-1.5 bg-green-600 rounded-full mt-0.5">
                                <x-heroicon-o-check class="w-4 h-4 text-black" />
                            </div>
                            <p class="text-sm text-gray-700 dark:text-gray-300 font-medium">Never share your credentials</p>
                        </div>
                        <div class="flex items-start gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                            <div class="flex-shrink-0 p-1.5 bg-green-600 rounded-full mt-0.5">
                                <x-heroicon-o-check class="w-4 h-4 text-black" />
                            </div>
                            <p class="text-sm text-gray-700 dark:text-gray-300 font-medium">Update password regularly</p>
                        </div>
                        <div class="flex items-start gap-3 p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                            <div class="flex-shrink-0 p-1.5 bg-green-600 rounded-full mt-0.5">
                                <x-heroicon-o-check class="w-4 h-4 text-black" />
                            </div>
                            <p class="text-sm text-gray-700 dark:text-gray-300 font-medium">Log out from shared devices</p>
                        </div>
                    </div>
                </div>
            </div>
